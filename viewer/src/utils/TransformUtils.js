...
define(function (require, exports, module) {
    ...
    TransformUtils.transformFromElement = function(me, l){
        ...
        while(l != parent){
            ...
            ltf = Transform.multiply4x4(tt, ltf);
            l = l.offsetParent;
        }
        // me to parent
        ...
        while(me != parent){
            ...
            mtf = Transform.multiply4x4(tt, mtf);
            me = me.offsetParent;
        }

        return Transform.multiply4x4(Transform.inverse(mtf), ltf);
    }
    ...
    TransformUtils.transformToElement = function(me, l){
        ...
        return Transform.multiply4x4(Transform.inverse(ltf), mtf);
    }

    // transform from child local system to its parent local system
    function __transformMapChildToParent(child){
...

        {
            ...
            m = Transform.multiply4x4(TransformUtils.elementTransform(child), m);
